...
main(int argc, char *const *argv)
{
    ...
    ngx_log_error(NGX_LOG_NOTICE, log,0 /* errno, Integer 0 indicates success */  , "log_fd: %d", log->file->fd);
    ngx_log_error(NGX_LOG_EMERG, log,0 /* errno, Integer 0 indicates success */  , "ngx_log_init success, NGX_LOG_EMERG");
    ngx_log_error(NGX_LOG_ALERT, log,0 /* errno, Integer 0 indicates success */  , "ngx_log_init success, NGX_LOG_ALERT");
    ngx_log_error(NGX_LOG_CRIT, log,0 /* errno, Integer 0 indicates success */  , "ngx_log_init success, NGX_LOG_CRIT");
    ngx_log_error(NGX_LOG_ERR, log,0 /* errno, Integer 0 indicates success */  , "ngx_log_init success, NGX_LOG_ERR");
    ngx_log_error(NGX_LOG_WARN, log,0 /* errno, Integer 0 indicates success */  , "ngx_log_init success, NGX_LOG_WARN");
    ngx_log_error(NGX_LOG_NOTICE, log,0 /* errno, Integer 0 indicates success */  , "ngx_log_init success, NGX_LOG_NOTICE");
    ngx_log_error(NGX_LOG_INFO, log, 0 /* errno, Integer 0 indicates success */ , "ngx_log_init success, NGX_LOG_INFO");
    ngx_log_error(NGX_LOG_DEBUG, log,0 /* errno, Integer 0 indicates success */  , "ngx_log_init success, NGX_LOG_DEBUG");
	...
	ngx_log_error(NGX_LOG_NOTICE, log, 0, "log_fd: %d", log->file->fd);
